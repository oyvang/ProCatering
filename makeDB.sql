...
CREATE TABLE corporate_register (
  ...
  clean_corporatename VARCHAR(255))
  ENGINE =InnoDB;
...
CREATE TABLE cat_dish (
  ...
  CONSTRAINT cat_dish PRIMARY KEY (cat_id, dish_id))
  ENGINE =InnoDB;
...
CREATE TABLE employee_types (
  ...
  CONSTRAINT order_dish_pk PRIMARY KEY (employee_id, type_id))
  ENGINE =InnoDB;
...
CREATE TABLE dish_ingredient (
  ...
  CONSTRAINT dish_ingredient_pk PRIMARY KEY (dish_id, ingredient_id))
  ENGINE =InnoDB;
...
ADD CONSTRAINT cat_dish_fk1 FOREIGN KEY (cat_id) REFERENCES categories (cat_id) -- ON DELETE CASCADE;
mulighet
